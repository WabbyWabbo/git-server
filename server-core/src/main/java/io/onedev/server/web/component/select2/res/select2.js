...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请再输入 " + n + " 个字符" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请删除 " + n + " 个字符" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "你只能选择 " + limit + " 项" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "载入更多结果..."; },
